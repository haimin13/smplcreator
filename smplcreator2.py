...
db_dir = os.path.dirname(os.path.realpath(__file__)) + "\\음악DB.csv"
del_dir = os.path.dirname(os.path.realpath(__file__)) + "\\db_del.csv"
pc_dir = "D:/음악/음악"
db_temp_csv = os.path.dirname(os.path.realpath(__file__)) + "\\sorted_음악DB.csv"
pc_temp_csv = os.path.dirname(os.path.realpath(__file__)) + "\\sorted_pc_data.csv"
div_line = "\n========================================\n"
help = """
    quit - 프로그램을 종료합니다.
